...
\{
        ...
        \textcolor{keywordtype}{char}*   \hyperlink{lp__lib_8h_a113fd968c78bb9d1464b0912bfceb58c}{message};
        ...
        result = \hyperlink{libstructural_8h_a8fe9803fda8adddfd10c7d48f6fdbfe1}{LibStructural\_loadSBMLFromFile}(argv[1], &message, &length);
        ...
        \hyperlink{libstructural_8h_a43ec36f000082b338e1aad9cff3b0b23}{LibStructural\_freeVector}(message);
        
        \textcolor{comment}{// obtain and print the test results}
        \hyperlink{libstructural_8h_a76fa7cdfb5333db9e78bf36ac6bc292e}{LibStructural\_getTestDetails}( &message, &length );
        printf(\textcolor{stringliteral}{"%s"}, message);
