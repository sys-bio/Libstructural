...
\textcolor{keywordtype}{void} \hyperlink{loadlabelledstoichiometry_8c_a45d5e3cd5275b375230af630e15886ce}{GetMatrixFromSomeWhere}(\textcolor{keywordtype}{double}** *oMatrix, \textcolor{keywordtype}{int} *nRows, \textcolor{keywordtype}{int} *nCols, 
...
\textcolor{keywordtype}{void} \hyperlink{loadlabelledstoichiometry_8c_ae467e9e38b5eb49f8559695a4341e44b}{PrintReorderedStoichiometryMatrix}();

\textcolor{comment}{// gets the gamma matrix from the librar}
\textcolor{keywordtype}{void} \hyperlink{loadlabelledstoichiometry_8c_ac99d30fb2b9d6e7f5c08e9fff04feab8}{PrintGammaMatrix}();


\textcolor{keywordtype}{int} \hyperlink{arithchk_8c_a840291bc02cba5474a4cb46a9b9566fe}{main} (\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv)
\{
        \textcolor{keywordtype}{int}      i,\hyperlink{lp__lib_8h_a06b53c1efb3823879093de05b4e0b46b}{j};
        ...
        \textcolor{keywordtype}{char}**   \hyperlink{namespacepython_test_a0a8e8643e0a24523d16aa025aa13df5c}{speciesNames};
        \textcolor{keywordtype}{char}**   \hyperlink{namespacepython_test_a004f052ba812c8e03bbab159cd7d3b75}{reactionNames};
        ...
        \hyperlink{loadlabelledstoichiometry_8c_a45d5e3cd5275b375230af630e15886ce}{GetMatrixFromSomeWhere}(&oMatrix, &nRows, &nCols, 
               &speciesNames, &initialConcentrations, &reactionNames);
        
        
        \textcolor{comment}{// load matrix into the structural analysis library}
        \hyperlink{libstructural_8h_a9ac01e88f015f584389d08fcf721ba7d}{LibStructural\_loadStoichiometryMatrix} (oMatrix, nRows, nCols);
        \textcolor{comment}{// load species names and initial concentrations}
        \hyperlink{libstructural_8h_a6e313370663b6098b228f251129eaddc}{LibStructural\_loadSpecies}(speciesNames, initialConcentrations, nRows);
        \textcolor{comment}{// load reaction names}
        \hyperlink{libstructural_8h_a2e96b0ac21b0026228a600b754759f93}{LibStructural\_loadReactionNames}(reactionNames, nCols);
        
        \textcolor{comment}{// analyze the stoichiometry matrix using the QR method}
        \hyperlink{libstructural_8h_a505eacbf357b087e0d10a09feb0d69e2}{LibStructural\_analyzeWithQR}( &sMessage, &nLength);
        ...
        \hyperlink{libstructural_8h_a43ec36f000082b338e1aad9cff3b0b23}{LibStructural\_freeVector}(sMessage);
        
        \textcolor{comment}{// obtain and print the test results}
        \hyperlink{libstructural_8h_a76fa7cdfb5333db9e78bf36ac6bc292e}{LibStructural\_getTestDetails}( &sMessage, &nLength );
        printf(\textcolor{stringliteral}{"%s"}, sMessage);
        ...
        \hyperlink{loadlabelledstoichiometry_8c_ae467e9e38b5eb49f8559695a4341e44b}{PrintReorderedStoichiometryMatrix}();
        
        \textcolor{comment}{// Print Gamma Matrix}
        \hyperlink{loadlabelledstoichiometry_8c_ac99d30fb2b9d6e7f5c08e9fff04feab8}{PrintGammaMatrix}();
...
\{
        ...
        \hyperlink{libstructural_8h_a7a4bb54cd3509c8c7f014eb1ffba155b}{LibStructural\_getReorderedStoichiometryMatrix}
                (&reorderedStoichiometryMatrix, &reorderedNumRows, &reorderedNumCols);
        \hyperlink{libstructural_8h_a385210f1ccbddaf02f28efc490ca4114}{LibStructural\_getReorderedStoichiometryMatrixLabels}
        ...
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)reorderedStoichiometryMatrix, 
      reorderedNumRows);
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)reorderedCols, reorderedNumCols);
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)reorderedRows, reorderedNumRows);
...
\{
        ...
        \hyperlink{libstructural_8h_ad8fcf1c405fed42135b1a9c0f8290655}{LibStructural\_getGammaMatrix}
                (&gammaMatrix, &gammaNumRows, &gammaNumCols);
        \hyperlink{libstructural_8h_aed6a2f6cfa77f69bfdee264b7dc4c004}{LibStructural\_getGammaMatrixLabels}
        ...
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)gammaMatrix, gammaNumRows);
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)gammaCols, gammaNumCols);
        \hyperlink{libstructural_8h_a12ff3358b228a0e3a9fbefee2af8103f}{LibStructural\_freeMatrix}((\textcolor{keywordtype}{void}**)gammaRows, gammaNumRows);
