...
class LibStructural(_object):
    ...
    def _my_getLinkMatrix(self): return _structural.LibStructural__my_getLinkMatrix(self)
    ...
    def _my_getRank(self, *args): return _structural.LibStructural__my_getRank(self, *args)
    def getRCond(self, *args): return _structural.LibStructural_getRCond(self, *args)
